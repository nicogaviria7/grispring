...
public interface ProduccionRepository extends JpaRepository<Produccion, Long> {
	...
	@Transactional
	@Modifying
	@Query("UPDATE co.edu.uniquindio.gri.model.Produccion p SET p.estado=:estado WHERE p.id=:id")
	public void updateProduccion(@Param("id") Long id, @Param("estado") int estado);

	@Transactional
	@Modifying
	@Query("UPDATE co.edu.uniquindio.gri.model.ProduccionB p SET  p.estado=:estado WHERE p.id=:id")
	public void updateProduccionB(@Param("id") Long id, @Param("estado") int estado);
